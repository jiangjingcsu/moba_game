...
public class AuthController {
    ...
    @PostMapping("/refresh")
    public ApiResponse refresh(@RequestHeader("X-Player-Id") String playerId,
                               @RequestHeader("X-Username") String username) {
        String token = JwtUtil.generateToken(Long.parseLong(playerId), username, jwtSecret, jwtExpiration);
