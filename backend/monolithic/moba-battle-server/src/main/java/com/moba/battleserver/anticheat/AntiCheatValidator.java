package com.moba.battleserver.anticheat;
...
public class AntiCheatValidator {
    private static AntiCheatValidator instance;
    ...
    public static synchronized AntiCheatValidator getInstance() {
        if (instance == null) {
            instance = new AntiCheatValidator();
        }
        return instance;
    }
