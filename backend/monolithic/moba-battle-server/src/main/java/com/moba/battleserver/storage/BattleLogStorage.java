package com.moba.battleserver.storage;
...
public class BattleLogStorage {
    private static BattleLogStorage instance;
    ...
    public static synchronized BattleLogStorage getInstance() {
        if (instance == null) {
            instance = new BattleLogStorage();
        }
        return instance;
    }
    ...
    private void saveLogEntry(BattleLogEntry entry) {
        try {
            ...
            String filePath = dateDir + File.separator + entry.getBattleId() + ".log.gz";
